...
export async function appRoutes(app: FastifyInstance) {
    ...
    app.get('/categorias', { preHandler: [authMiddleware] }, new CategoryController().index)
    app.post('/categorias/criar', { preHandler: [authMiddleware] }, new CategoryController().create)
    app.post('/categorias/:id', { preHandler: [authMiddleware] }, new CategoryController().edit)
    app.delete('/categorias/:id', { preHandler: [authMiddleware] }, new CategoryController().delete)
